...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        \vspace{5cm}
        \centering
        \textbf{[Insert Arithmetic Operations Simulation Screenshot]}
        
        \textit{File name: simulation\_arithmetic.png}
        \vspace{0.5cm}
    }}
...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        \vspace{5cm}
        \centering
        \textbf{[Insert Multiplication/Division Simulation Screenshot]}
        
        \textit{File name: simulation\_mult\_div.png}
        \vspace{0.5cm}
    }}
...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        \vspace{5cm}
        \centering
        \textbf{[Insert Logic Operations Simulation Screenshot]}
        
        \textit{File name: simulation\_logic.png}
        \vspace{0.5cm}
    }}
...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        \vspace{6cm}
        \centering
        \textbf{[Insert Complete Hardware Implementation Photo]}
        
        \textit{File name: hardware\_complete.jpg}
        \vspace{0.5cm}
    }}
...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        \vspace{5cm}
        \centering
        \textbf{[Insert Hardware Testing/Demonstration Photo]}
        
        \textit{File name: hardware\_testing.jpg}
        \vspace{0.5cm}
    }}
